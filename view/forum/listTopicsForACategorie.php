            ...
            <div id="navPage">
                <div id="upNav">
                    ...
                    if($_GET["page"] > 1){
                        ?>
                        <div class="mouvNav">
                            <a href="index.php?ctrl=forum&action=listTopicsForACategorie&id=<?= $_GET['id'] ?>&page=1"><<</a>
                            <a href="index.php?ctrl=forum&action=listTopicsForACategorie&id=<?= $_GET['id'] ?>&page=<?= $_GET["page"]-1 ?>">&nbsp;<&nbsp;</a>
                        </div>
                        <?php
                    }
                    else{
                    ...
                    if($_GET["page"] != $max){
                        ...
                        <div class="mouvNav">
                            <a href="index.php?ctrl=forum&action=listTopicsForACategorie&id=<?= $_GET['id'] ?>&page=<?= $_GET["page"]+1 ?>">&nbsp;>&nbsp;</a>
                            <a href="index.php?ctrl=forum&action=listTopicsForACategorie&id=<?= $_GET['id'] ?>&page=<?= $max ?>">>></a>
                        </div>
                        <?php
                    }
                    else{
